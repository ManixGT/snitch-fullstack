    ...
    <div className="bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="w-36 h-10 rounded flex items-center justify-center text-sm font-medium">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:flex items-center">
              <div className="relative flex items-center h-10 mx-4 border border-black min-w-[250px]">
                ...
                {!search && (
                  <div className="absolute left-10 top-0 bottom-0 right-4 overflow-hidden pointer-events-none flex items-center">
                    <div className="relative h-full w-full">
                      <div
                        key={currentIdx} // Forces re-render and animation restart
      ...
      <style jsx>{`
        ...
        .animate-textCycle {
          animation: textCycle 3s ease-out infinite;
        }
      `}</style>
    </div>
  );
